...
WebUI.setText(findTestObject('Daftar/Daftar Email/input_Email_email'), 'yunirahayuanggun@yopmail.com')

WebUI.click(findTestObject('Daftar/Daftar Email/button_Lanjutkan'))

WebUI.setText(findTestObject('Daftar/Daftar Email/input_otp-1_otp-1'), '1')

WebUI.setText(findTestObject('Daftar/Daftar Email/input_otp-2_otp-2'), '2')

WebUI.setText(findTestObject('Daftar/Daftar Email/input_otp-3_otp-3'), '3')

WebUI.setText(findTestObject('Daftar/Daftar Email/input_otp-4_otp-4'), '4')
