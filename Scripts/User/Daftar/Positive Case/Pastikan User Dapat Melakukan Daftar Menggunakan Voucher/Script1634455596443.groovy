...
WebUI.setText(findTestObject('Register Voucher/input_Username_code'), 'PJRQA05')

WebUI.setText(findTestObject('Register Voucher/input_Password_password'), '123Abcde')

WebUI.click(findTestObject('Register Voucher/button_Masuk'))

WebUI.setText(findTestObject('Register Voucher/input_Nama Lengkap_fullname'), 'Mas Kun QA')

WebUI.setText(findTestObject('Register Voucher/input_Email_email'), 'masqun@yopmail.com')

WebUI.setText(findTestObject('Register Voucher/input_Nomor Telepon_phone'), '897766542311')
