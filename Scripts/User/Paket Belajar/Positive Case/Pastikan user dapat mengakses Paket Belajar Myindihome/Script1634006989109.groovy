...
WebUI.click(findTestObject('Paket Belajar/Page_Pijar Belajar/button_Pilih Paket'))

WebUI.scrollToElement(findTestObject('Paket Belajar/Page_Pijar Belajar/h3_Paket Belajar Indihome'), 1)

WebUI.click(findTestObject('Paket Belajar/Page_Pijar Belajar/svg_next'))

WebUI.click(findTestObject('Paket Belajar/Page_Pijar Belajar/svg_prev'))

WebUI.click(findTestObject('Paket Belajar/Page_Pijar Belajar/svg_next'))

WebUI.click(findTestObject('Paket Belajar/Page_Pijar Belajar/button_Berlangganan_indihome'))
