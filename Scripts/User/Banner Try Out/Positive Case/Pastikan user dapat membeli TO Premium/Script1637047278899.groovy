...
WebUI.scrollToElement(findTestObject('Try Out/Page_Pijar Belajar Tryout/p_Tryout 6'), 0)

WebUI.focus(findTestObject('Try Out/Page_Pijar Belajar Tryout/p_Tryout 6'))

WebUI.click(findTestObject('Try Out/Beli TO/New Folder/div_Tryout 6tr-6Rp200.000Lihat Detail24 Nov 20217 Hari 23 jam 01 Menit'))

WebUI.click(findTestObject('Try Out/Beli TO/Page_Pijar Belajar Tryout/button_Daftar Sekarang'))

WebUI.setText(findTestObject('Try Out/Beli TO/Page_Pijar Belajar Tryout/input_Nama_name_student'), 'Sinta')

WebUI.setText(findTestObject('Try Out/Beli TO/Page_Pijar Belajar Tryout/input_Email_email'), 'sintadewi@yopmail.com')

WebUI.setText(findTestObject('Try Out/Beli TO/Page_Pijar Belajar Tryout/input_Nomor Handphone_phone'), '8977625122111')
...
WebUI.setText(findTestObject('Try Out/Beli TO/Page_Pijar Belajar Tryout/input_Nomor Induk Siswa_nis'), '11111111111')
...
WebUI.click(findTestObject('Try Out/Beli TO/Premium/div_LinkAja (Via Web)'))

WebUI.click(findTestObject('Try Out/Beli TO/Premium/button_Bayar'))
